...
<Modal bind:showModal={showWordLibraryManager} on:close={() => showWordLibraryManager = false} fullScreen={false}>
...
<div class="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <form on:submit|preventDefault={() => handleSearch()}>
        <div class="relative">
          <input 
            ...
            class="w-full bg-white dark:bg-gray-800 text-md pl-10 pr-24 
 py-3 rounded-xl border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
          ...
          {/if}
          <button type="submit" aria-label="Search" class="absolute top-1/2 right-2 -translate-y-1/2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg p-2 flex items-center 
 justify-center transition-all" disabled={isLoading}>
            {#if isLoading}
 ...
 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            {/if}
          </button>
        </div>
      </form>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button on:click={() => showAdvancedSearch = true} class="bg-white 
 dark:bg-gray-800 hover:dark:bg-gray-700 p-4 rounded-lg text-left transition-colors shadow">
